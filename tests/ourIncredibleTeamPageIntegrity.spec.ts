describe('Check the integrity of the UI/UX of the Our Incredible Team', () => {
    it('Page Our Incredible Team', async () => {
        ...
        // Contact Us
        await $('.elementor-element-4f9cf0d8').click()
        await browser.pause(2000)
        await expect($('.elementor-element-8f78e74 .elementor-widget-container')).toHaveText('Contact Us')
        await expect($('#name')).toBeExisting()
        await expect($('#email')).toBeExisting()
        
        await $('.elementor-element-499d5edd').scrollIntoView({ block: 'center', inline: 'center' });
        await browser.pause(2000)
